...
....
#> ✔ Creating '/tmp/Rtmpfx81wU/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpfx81wU/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|5ffc58ee4b… |batpigandme batpigandme@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpfx81wU/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpfx81wU/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpfx81wU/regexcite/README.Rmd'
----
