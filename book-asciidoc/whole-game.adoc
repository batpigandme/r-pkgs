...
....
#> ✔ Creating '/tmp/RtmpWIlryU/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpWIlryU/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|0ce3466eec… |batpigandme batpigandme@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpWIlryU/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpWIlryU/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpWIlryU/regexcite/README.Rmd'
----
