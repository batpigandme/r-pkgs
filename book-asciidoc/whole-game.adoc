...
....
#> ✔ Creating '/tmp/RtmpKCLHPg/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpKCLHPg/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|5cbc25322e… |batpigandme batpigandme@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpKCLHPg/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpKCLHPg/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpKCLHPg/regexcite/README.Rmd'
----
