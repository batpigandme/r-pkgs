...
....
#> ✔ Creating '/tmp/RtmpclC8tz/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpclC8tz/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|091b72bae2… |batpigandme batpigandme@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpclC8tz/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpclC8tz/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpclC8tz/regexcite/README.Rmd'
----
