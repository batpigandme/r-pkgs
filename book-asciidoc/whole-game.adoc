...
....
#> ✔ Creating '/tmp/Rtmpnnl1Uu/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmpnnl1Uu/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|39a6c0211b… |batpigandme batpigandme@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpnnl1Uu/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpnnl1Uu/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpnnl1Uu/regexcite/README.Rmd'
----
