...
** Documentation for individual functions via https://CRAN.R-project.org/package=roxygen2[roxygen2].
...
....
#> ✔ Creating '/tmp/RtmpQX3YA0/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpQX3YA0/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
[width="100%",cols="<19%,<63%,<18%",options="header",]
|===
|commit |author |message
|ea05c38c24… |batpigandme batpigandme@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpQX3YA0/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpQX3YA0/regexcite_0.0.0.9000.tar.gz --install-tests 
...
Now that your package is on GitHub, the `+README.md+` file matters. It is the package’s home page and welcome mat, at least until you decide to give it a website (see https://pkgdown.r-lib.org[pkgdown]), add a vignette (see <<sec-vignettes>>), or submit it to CRAN (see <<sec-release>>).
...
#> ℹ Building '/tmp/RtmpQX3YA0/regexcite/README.Rmd'
----
